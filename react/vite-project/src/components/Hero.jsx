...
function Hero({ user }) {
  ...
  const handleGetStarted = () => {
    if (user) {
      navigate("/career-form"); // logged-in users go to career form
    } else {
      navigate("/form"); // not logged in → go to academic form first
    }
  };
    ...
    <section className="hero">
      <div className="hero-content">
        {user ? (
          <>
            <h1>
              Hello {user.name}, welcome to our platform to strengthen your career journey
            </h1>
